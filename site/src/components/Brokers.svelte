<script lang="ts">
    import { IBKRAdapter, DEGIROAdapter, Trading212Adapter, BoursoramaAdapter, FidelityAdapter } from "../tobcalc-lib.js";
...
<div class="selected-service">
    ...
    {:else if selectedBroker === Broker.Fidelity}
        <BrokerAdapter selectedBrokerNumber={selectedBrokerNumber} broker={selectedBroker} brokerAdapter={FidelityAdapter} />
    {/if}
</div>
{/each}